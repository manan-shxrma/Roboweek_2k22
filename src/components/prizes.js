          ...
          <div className='row'>
            <div className='col-lg-5'>
              <div data-aos='fade-right' className='section-heading wow fadeInLeft' data-wow-duration='1s' data-wow-delay='0.3s'>
                <h6>Roboweek 2.0 event prizes</h6>
                <h4 style={{ color: "white" }}>
                  schwagy & sassy<em> Roboweek</em>
                </h4>
        ...
        <div className='container'>
          <div className='row'>
            <div className='col-lg-12'>
              <div data-aos='fade-right' className='section-heading wow fadeInLeft' data-wow-duration='1s' data-wow-delay='0.3s'>
                <h4 style={{ color: "white", paddingTop: "3%", paddingBottom: "2%", textAlign: "center" }}>Schwagy For all participants</h4>
              </div>
            </div>
          </div>
          <div style={{ paddingLeft: "5%", paddingRight: "5%" }}>
            <div style={{ background: "rgba(0, 0, 0, 0.5)", borderRadius: "25px", color: "#fff", padding: "10px" }} className='row'>
              ...
              <div className='col-lg-6 col-md-6 col-sm-12'>
                <ul style={{ paddingTop: "20%", paddingBottom: "5%", paddingRight: "10%", paddingLeft: "0" }}>
                  <li className='allparli'>
                    <i class='ion-university' /> 5-Year free upgrades for participants
                  </li>
                  <li className='allparli'>
                    <i class='ion-university' /> Provide 10% discount coupons on all the apparels
                  </li>
                  <li className='allparli'>
                    <i class='ion-university' /> 1 month free hosting on Expansion
                  </li>
                  <li className='allparli'>
                    <i class='ion-university' /> 25% off the first year of 1Password Families
                  </li>
                  <li className='allparli'>
                    <i class='ion-university' /> Free course access on Full Coding Interview Prep Course
                  </li>
                  <li className='allparli'>
                    <i class='ion-university' /> 90-day extended trial promo of Balsamiq Cloud
                  </li>
                </ul>
              </div>
            </div>
