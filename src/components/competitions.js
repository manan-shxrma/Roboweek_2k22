                                ...
                                <div className="col-lg-12 align-self-center">
                                  <div className="left-text">
                                    ...
                                    <div className="col-lg-6">
                                      ...
                                      <p>
                                        Hello there, y'all! ✋ There's a chance
                                        to land a full-time job or an
                                        internship. Robotics society NIT
                                        hamirpur presents Flipr hackathon.☄️
                                        This Hackathon will be entirely online,
                                        and a number of firms will be on the
                                        lookout for exceptional individuals to
                                        join their exclusive team.🤵This
                                        Hackathon will provide pre-final and
                                        final-year students with placement and
                                      ...
                                      >
                                        ...
                                        <span>
                                          ...
                                          The top 3 will receive placement
                                          <br />
                                        ...
                                        <span>
                                          <i className="fa fa-check"></i>
                                          The Hackathon is two day
                                          <br />
                                          long starting from
                                          <br />
                                          25th march at 9:00 PM.
                                        </span>{" "}
                                      </div>
