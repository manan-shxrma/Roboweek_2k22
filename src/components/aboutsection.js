          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="row">
                <div
                  data-aos="fade-in"
                  className="paddingofaboutimage col-lg-6"
                >
                  <img
                    src="assets/images/robosoc-team2.JPG"
                    className="imgabout"
                    alt="visit"
                  />
                </div>
                ...
                >
                  <div className="about-right-content">
                    ...
                    <p style={{ fontSize: "larger" }}>
                      <strong>
                        {" "}
                        It is a blend of affairs encompassing week long enticing
                        activities ranging from guest talks, robotic workshops,
                        coding manias, fun events, cryptic hunt, quizzes and
                        much more.
                      </strong>
                      <h4 style={{ color: "#f7931e" }} className="py-4">
                ...
                >
                  <div className="about-right-content">
                    <div data-aos="fade-up" className="section-heading">
                      <h6>About Us</h6>
                      <h4>
                        Unity in <em>Diversity</em>
                      </h4>
                      <div className="line-dec"></div>
                    </div>
                    <p style={{ fontSize: "larger" }}>
                      <strong>
                        RoboWeek is trying to promote diversity by conducting
                        events specially endorsed for girls, thereby promoting
                        women participation in technical field and hence
                        empowering women.
                      </strong>
                    </p>
                    <b>
                      <p class="quote">
                        <strong>"</strong>
                        WOMEN ARE BOTH TALENTED AND INNOVATIVE THINKERS AND TEND
                        TO USE SCIENCE TO LOOK FOR SOLUTIONS.<strong>
                          "
                        </strong>{" "}
                        <br /> Kimberly Bryant{" "}
                      </p>
